...
function playAlarmSound() {
  ...
  try {
    // Tenta diferentes caminhos possíveis para o arquivo de áudio
    const audioPaths = [
      'alarm2.wav',
      './alarm2.wav',
      '../Timer de Desafio/alarm2.wav',
      'Timer de Desafio/alarm2.wav'
    ];
    ...
    // Se nenhum áudio funcionou, usa Web Audio API como fallback
    if (!audioPlayed) {
      try {
