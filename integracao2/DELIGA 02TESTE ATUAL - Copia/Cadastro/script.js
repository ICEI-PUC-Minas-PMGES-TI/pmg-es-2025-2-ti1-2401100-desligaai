...
function setupSignupForm() {
    ...
    // Conecta o botão customizado ao input file
    ...
    if (photoUpload) {
        photoUpload.addEventListener('change', function(e) {
            ...
            if (file) {
                // Atualiza o nome do arquivo no botão
                ...
                // Mostrar preview e converter para base64
